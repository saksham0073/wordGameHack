...
class wordPermutation{
		...
		try{
			...
			//MODULE 2 : STORE INPUT LETTERS IN AN ARRAY
			...
			//MODULE 4 : EXTRACT WORDS STARTING WITH INPUT LETTERS AND COMPARE WITH PERMUTATED WORDS
			...
			//MODULE 2 - 60 3-word permutations for the 5 input letters
			int count=0;
