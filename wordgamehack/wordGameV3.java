...
class wordPermutation{
        ...
        String[] dictionary = new String[1004];
		...
		try{
			...
			for(i=0;i<1004;i++)
			{
				...
				//extract only the words which start with the first letter of the input letters
					...
					System.out.println(letter1matched[i]);
				}
			}
			...
			for(i=0;i<1004;i++)
			{
				...
				//extract only the words which start with the first letter of the input letters
					...
					System.out.println(letter2matched[i]);
				}
			}
			...
			for(i=0;i<1004;i++)
			{
				...
				//extract only the words which start with the first letter of the input letters
					...
					System.out.println(letter3matched[i]);
				}
			}
			...
			for(i=0;i<1004;i++)
			{
				...
				//extract only the words which start with the first letter of the input letters
					...
					System.out.println(letter4matched[i]);
				}
			}
			...
			for(i=0;i<1004;i++)
			{
				...
				//extract only the words which start with the first letter of the input letters
					...
					System.out.println(letter5matched[i]);
				}
			}
			...
			for(i=0;i<1;i++)
            {
				...
				System.out.println("No matches for letter "+word[0]);
					break;
				}
            }
            //letter 2
            ...
            for(i=1;i<2;i++)
            {
				...
				System.out.println("No matches for letter "+word[1]);
					break;
				}
            }
            //letter 3
            ...
            for(i=2;i<3;i++)
            {
				...
				System.out.println("No matches for letter "+word[2]);
					break;
				}
            }
			//letter 4
			...
			for(i=3;i<4;i++)
            {
				...
				System.out.println("No matches for letter "+word[3]);
					break;
				}
            }
			//letter 5
            ...
            for(i=4;i<5;i++)
            {
				...
				for(i=0;i<15;i++)
				{
					...
					System.out.println("No matches for letter "+word[4]);
					break;
				}
            }
		}
